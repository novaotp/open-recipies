...
<body class="relative z-0 p-10 flex flex-col justify-center">
  ...
  <a href="/auth/sign-up" class="relative w-full h-[60px] flex justify-center items-center rounded-md text-white bg-orange-500 mt-10">Sign Up</a>
  <p
  ...
  <a href="/auth/log-in" class="relative w-full h-[60px] flex justify-center items-center rounded-md text-orange-500 border border-orange-500 bg-white">Log In</a>
</body>
</html>
