...
<head>
  ...
  <title>Create a new recipy | Coo-King</title>
...
<body class="relative z-0">
    ...
    <nav class="fixed w-full h-20 p-5 flex justify-between items-center bg-[#222222] z-40">
        <a class="relative h-full flex items-center px-5 bg-gray-800 rounded-xl" href="<?= $routes->get('recipies')->getPath(); ?>">
            <!-- Left arrow icon -->
    ...
    <main class="relative w-full h-[calc(100%-5rem)] top-20 px-5 pb-5 flex flex-col justify-center items-center">
