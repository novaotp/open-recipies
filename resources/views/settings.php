...
<body class="relative z-0">
    ...
    <?php endif; ?>
    <main class="relative w-full h-[calc(100%-80px)] top-20 p-5 flex flex-col items-center">
        <article class="relative w-full max-w-[600px] h-[calc(100%-80px)] top-10">
            ...
            <form action="<?= $routes->get("settings")->getPath(); ?>" method="POST" class="relative w-full flex flex-col items-center">
                ...
                <div class="relative w-full h-[60px] mb-5">
                    ...
                    <input class="relative w-full h-full px-5 rounded-xl" type="text" name="lastName" value="<?= $user->lastName(); ?>" placeholder="Enter your new last name here..." required autoComplete="off" />
                </div>
                <div class="relative w-full h-[60px] mb-5">
                    <label htmlFor="firstName" class="absolute -top-2 left-4 z-10 rounded-xl bg-black text-white text-xs px-2">First Name</label>
                    <input class="relative w-full h-[60px] px-5 rounded-xl" type="text" name="firstName" value="<?= $user->firstName(); ?>" placeholder="Enter your new first name here..." required autoComplete="off" />
                </div>
                <div class="relative w-full h-[60px] mb-5">
                    <label htmlFor="email" class="absolute -top-2 left-4 z-10 rounded-xl bg-black text-white text-xs px-2">Email</label>
                    <input class="relative w-full h-[60px] px-5 rounded-xl" type="email" name="email" value="<?= $user->email(); ?>" placeholder="Enter your new email here..." required autoComplete="off" />
                </div>
                <div class="relative w-full h-[60px] mb-5">
                    <label htmlFor="password" class="absolute -top-2 left-4 z-10 rounded-xl bg-black text-white text-xs px-2">Password</label>
                    <input class="relative w-full h-[60px] px-5 rounded-xl" type="password" name="password" placeholder="Enter your new password here..." required autoComplete="off" />
                </div>
