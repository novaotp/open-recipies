...
<menu id="nav-menu" class="absolute top-0 -left-full h-full w-full bg-[#222222] duration-200 ease-out z-50 flex flex-col">
    <nav class="relative h-20 p-5 flex justify-between items-center">
        ...
        <a href="/recipies" class="text-white p-2 flex items-center">
    ...
    <ul class="relative w-full flex-grow flex flex-col justify-between p-5">
        ...
        <li class="<?= $isConnected ? "block" : "hidden" ?> relative w-full h-[60px] mb-5">
            <a href="/dashboard" class="relative <?= $uri === "/dashboard" ? "bg-white text-gray-800" : "bg-gray-800 text-white"; ?> w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Home Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="<?= $uri === "/dashboard" ? "fill-gray-800" : "fill-white"; ?>" height="16" width="18" viewBox="0 0 576 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
        ...
        <li class="relative w-full h-[60px] mb-5">
            <a href="/recipies" class="relative <?= $uri === "/recipies" ? "bg-white text-gray-800" : "bg-gray-800 text-white"; ?> w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Food Bowl Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="<?= $uri === "/recipies" ? "fill-gray-800" : "fill-white"; ?>" height="16" width="16" viewBox="0 0 512 512">
        ...
        <li class="<?= $isConnected ? "block" : "hidden" ?> relative w-full h-[60px]">
            <a href="/recipies/create" class="relative <?= $uri === "/recipies/create" ? "bg-white text-gray-800" : "bg-gray-800 text-white"; ?> w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Plus Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="<?= $uri === "//recipies/create" ? "fill-gray-800" : "fill-white"; ?>" height="16" width="14" viewBox="0 0 448 512"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2023 Fonticons, Inc.-->
        ...
        <li class="<?= $isConnected ? "block" : "hidden" ?> relative w-full h-[60px] mb-5">
            <a href="/settings" class="relative <?= $uri === "/settings" ? "bg-white text-gray-800" : "bg-gray-800 text-white"; ?> w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Gear Icon -->
            <svg xmlns="http://www.w3.org/2000/svg" class="<?= $uri === "/settings" ? "fill-gray-800" : "fill-white"; ?>" height="16" width="16" viewBox="0 0 512 512">
        ...
        <li class="<?= $isConnected ? "hidden" : "block" ?> relative w-full h-[60px] mb-5">
            <a href="/auth/sign-up" class="bg-orange-500 text-white relative w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Add User Icon -->  
        ...
        <li class="<?= $isConnected ? "hidden" : "block" ?> relative w-full h-[60px]">
            <a href="/auth/log-in" class="bg-white text-orange-500 border relative w-full h-full p-5 rounded-xl flex justify-between items-center">
            <!-- Log Out Icon -->  
